    ...
    <nav className="w-full px-4 py-3 bg-white text-black dark:bg-[#1a1a1a] dark:text-white shadow-md border-b dark:border-gray-700">
        ...
        <div className="flex items-center gap-2">
          ...
          {isLoggedIn ? (
            <button
              ...
              className="text-sm bg-red-600 text-white px-3 py-1 rounded hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600 transition"
            >
              Logout
            </button>
          ) : (
      ...
      <div className="hidden md:flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex gap-10 text-base">
          <Link to="/track-expenses" className="hover:text-[#f0a500] hover:scale-105 transition">
            Dashboard
          </Link>
          <Link to="/track-expenses/transactions" className="hover:text-[#f0a500] hover:scale-105 transition">
            Transactions
          </Link>
          <Link to="/track-expenses/manage" className="hover:text-[#f0a500] hover:scale-105 transition">
            Manage
          </Link>
        </div>
